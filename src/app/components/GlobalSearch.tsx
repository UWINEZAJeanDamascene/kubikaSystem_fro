...
const PAGES: PageEntry[] = [
  ...
  { label: 'Imported Items', href: '/imported-items', group: 'Supply Chain', icon: DownloadCloud, keywords: 'import customs' },
  ...
  { label: 'Freight Bills', href: '/freight-bills', group: 'Supply Chain', icon: Truck, keywords: 'shipping' },
  { label: 'EBM Unmatched Purchases', href: '/ebm/unmatched-purchases', group: 'Supply Chain', icon: FileText, keywords: 'rra ebm' },
  { label: 'EBM Retry Queue', href: '/ebm/retry-queue', group: 'Supply Chain', icon: FileText, keywords: 'rra ebm' },
