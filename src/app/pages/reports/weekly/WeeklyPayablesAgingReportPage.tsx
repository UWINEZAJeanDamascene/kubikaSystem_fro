...
export default function WeeklyPayablesAgingReportPage() {
  ...
  return (
    <WeeklyReportScaffold title="Payables Aging" shortTitle="Payables" subtitle="Amounts owed to suppliers grouped by age bucket." icon={Receipt} tone="rose" loading={isLoading} downloading={downloading} onBack={() => navigate(-1)} onDownloadPDF={downloadPDF} onDownloadExcel={downloadExcel} metrics={metrics}>
